 ...
 */
class WebmVorbisDemuxer extends Transform {
  /**
   * Creates a new WebmVorbis demuxer.
 ...
 * @name WebmVorbisDemuxer#TOO_SHORT
 * @type {Symbol}
 */
const TOO_SHORT = WebmVorbisDemuxer.TOO_SHORT = Symbol('TOO_SHORT');
 ...
 * @name WebmVorbisDemuxer#TAGS
 * @type {Object}
 */
const TAGS = WebmVorbisDemuxer.TAGS = { // value is true if the element has children
  '1a45dfa3': true, // EBML
